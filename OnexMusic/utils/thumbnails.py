...
async def get_thumb(videoid, user_id, title=None, duration=None, thumbnail=None,
    ...
    try:
        ...
        try:
            font_badge_tmp = ImageFont.truetype("OnexMusic/assets/font2.ttf", 18 * SCALE)
        ...
        # ── fonts (scaled) ────────────────────────────────────────────────
        try:
            font_bold  = ImageFont.truetype("OnexMusic/assets/font2.ttf", 32 * SCALE)
            font_badge = ImageFont.truetype("OnexMusic/assets/font2.ttf", 18 * SCALE)
            font_small = ImageFont.truetype("OnexMusic/assets/font.ttf",  24 * SCALE)
            font_dur   = ImageFont.truetype("OnexMusic/assets/font.ttf",  22 * SCALE)
        except:
