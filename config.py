...
CybruxoApi_Url = getenv("CybruxoApi_Url", 'https://tgapi.xbitcode.com') ## xBit Music Endpoint.
CybruxoApi_Key = getenv("CybruxoApi_Key" , None ) ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Cybruxo/OnexMusic.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/CYBRUXO_AI_TEAM")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/CYBRUXO_AI_SUPPORT")
...
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "036b8c0097824bbb9ffc9c94110f68e7")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "a64c3cdd339241b99e3bc6cc61f9d4b1")
